            ...
            <div className="container">
                <nav className="menu">
                    <a onClick={ ( e ) => this.toggleAddForm( e ) }>
                        <span className={ this.state.displayAddForm ? "fas fa-times" : "fas fa-plus" }></span>
                        { this.state.displayAddForm ? " Fermer" : " Aidez-nous en agrandissant cette liste !" }
                    </a>
                </nav>
                ...
                <SearchBar
                    change = { ( e ) => this.handleSearchChange( e ) }
                />
                <List
                    change = { ( e ) => this.handleCompanyChange( e ) }
                    errors = { this.state.errors }
                    ...
                    companies = { this.state.companies.filter( ( company ) => {
                        ...
                        return [ company.name, company.city, company.works, company.techs ].reduce( ( acc, term ) => ( acc || term.toLowerCase().indexOf( query ) > -1 ), false );
                    } ) }
                />
            </div>
        );
